                ...
                for i in range(1,len(forms)):
                    if driver.find_elements_by_xpath("html/body/div/form["+str(i)+"]/table/tbody/tr[11]/td") !="Staff":
                        try:
                            ...
                            # construct the map
                            if i>1:
                                email_map[professor+str(i)] = (professor_email,driver.find_elements_by_xpath("html/body/div/form["+str(i)+"]/table/tbody/tr[13]/td")[0].get_attribute("innerText"))
                            else:
                                email_map[professor] = (professor_email,driver.find_elements_by_xpath("html/body/div/form["+str(i)+"]/table/tbody/tr[13]/td")[0].get_attribute("innerText"))
