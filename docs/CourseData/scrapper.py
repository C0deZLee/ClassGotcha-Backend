...
########################
# 02/05 version hope this will work
import re
import sys
import json
import os
                ...
                try:
                    ...
                    if len(forms) == 1:
                        ...
                        while professor_email=="http://www.work.psu.edu/ldap/": 
                            ...
                            if 'psu' in email[0].get_attribute("href")[7:]:
                                professor_email = email[0].get_attribute("href")[7:]
                            else:
                                pass
                        inUP = False
                        for temp1 in range(14,20):
                            try:
                                column_name = driver.find_elements_by_xpath("html/body/div/form["+str(i)+"]/table/tbody/tr["+str(temp1)+"]/th")[0].get_attribute("innerText")
                                if column_name =="Campus:":
                                    if "UNIVERSITY PARK" in driver.find_elements_by_xpath("html/body/div/form["+str(i)+"]/table/tbody/tr["+str(temp1)+"]/td")[0].get_attribute("innerText"):
                                        inUP =True
                                    else:
                                        pass
                                else:
                        ...
                        for i in range(1,len(forms)):
                            ...
                            shit = False
                            for temp2 in range(5,20):
                                try:
                                    column_name = driver.find_elements_by_xpath("html/body/div/form["+str(i)+"]/table/tbody/tr["+str(temp2)+"]/th")[0].get_attribute("innerText")
                                    if column_name == "Title:":
                                        name = driver.find_elements_by_xpath("html/body/div/form["+str(i)+"]/table/tbody/tr["+str(temp2)+"]/td")[0].get_attribute("innerText")
                                        if 'PROF' in name or 'GRAD' in name :
                                            shit  = True
                                    ...
                                    pass
                            # shit means this guy is a teacher
                            if shit:
                                professor_email = "http://www.work.psu.edu/ldap/"
